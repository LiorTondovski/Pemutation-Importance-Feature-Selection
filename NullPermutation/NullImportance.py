...
class NullPermutation:
    '''
        ...
        seed - type: int
               ...
               default: 12
        '''
    def __init__(self, df, label_column, task=Task, num_classes=NumClasses, classifier=Classifier, iteration_number=IterationNumber,
                seed=Seed):
    ...
    @staticmethod
    def get_mean_values_for_each_key(dic):
    ...
    def get_importance_according_to_real_label(self, X, y, data_columns):
        ...
        mean_importance_according_to_real_label = self.get_mean_values_for_each_key(actual_importance)
