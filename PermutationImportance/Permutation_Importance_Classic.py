...
class PermutationImportanceClassic(PermutationImportance):
    '''
        The class inherits from the PermutationImportance class.
        Feature selection is based on the assumption that null importance is normally distributed.
        ---------------------------------------------------------------------------------------------------------------
    ...
    def __init__(self, df, p_value=P_Value):
        super().__init__(df)
    ...
    def non_parametric_estimation(self, null_importance):
        ...
        mean_null_importance = self.get_mean_values_per_key(null_importance)
        std_null_importance = {}
...
if __name__ == '__main__':
    ...
    df = data['frame']
    null_permutation_instance = PermutationImportanceClassic(df)
